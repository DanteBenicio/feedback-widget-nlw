  ...
  return (
    <div className="flex flex-col items-center py-10 w-[304px]">
      ...
      <button
        ...
        className="py-2 px-4 font-medium rounded-md mt-2 cursor-pointer outline-none bg-zinc-800 hover:bg-zinc-700 focus:ring-2 focus:ring-offset-2 focus:ring-brand-500 focus:ring-offset-zinc-900 transition-colors"
      >
        Quero enviar outro
      </button>
    </div>
